...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'employee-list': RouteRecordInfo<'employee-list', '/employee/list', Record<never, never>, Record<never, never>>,
    'employee-view-id': RouteRecordInfo<'employee-view-id', '/employee/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
